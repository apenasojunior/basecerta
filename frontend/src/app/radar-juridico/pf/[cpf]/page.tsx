/**
 * Página de Listagem de Processos - Radar Jurídico PF
 * Exibe todos os processos de uma pessoa com filtros e paginação
 */
...
import { ProcessesHeader } from '@/components/radar-juridico/ProcessesHeader'
import { ProcessCard } from '@/components/radar-juridico/ProcessCard'
import { searchPessoaByCPF } from '@/mocks/radar-juridico-pf'
...
export default function RadarJuridicoProcessesPage({ params }: PageProps) {
  const { cpf } = use(params)
  
  // Buscar pessoa
  const cleanCPF = cpf.replace(/\D/g, '')
  const pessoa = searchPessoaByCPF(cleanCPF)
  ...
  const processedProcessos = useMemo(() => {
    ...
    return filtered
  }, [pessoa, selectedTribunais, selectedStatus, selectedTipos, sortBy])
          ...
          <CardContent className="pt-6">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                Não foram encontrados dados para o CPF informado.
              </p>
