 ...
 */ function assignDefaultsAndValidate(dir, userConfig, silent, phase) {
    ...
    if ((0, _canaryonlyconfigerror.isStableBuild)()) {
        var _result_experimental7;
        // Prevents usage of certain experimental features outside of canary
        if ((_result_experimental7 = result.experimental) == null ? void 0 : _result_experimental7.turbopackFileSystemCacheForBuild) {
    ...
    if (phase === _constants.PHASE_DEVELOPMENT_SERVER && ((_result_experimental6 = result.experimental) == null ? void 0 : _result_experimental6.isolatedDevBuild)) {
