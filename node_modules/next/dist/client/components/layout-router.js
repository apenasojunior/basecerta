...
function getBoundaryNameForSuspenseDevTools(subtree) {
    ...
    if (typeof segment === 'string') {
        ...
        // defined components.
        if (segment === '' || // For some reason, the loader tree sometimes includes extra __PAGE__
        // "layouts" when part of a parallel route. But it's not a leaf node.
        // Otherwise, we wouldn't need this special case because pages are
        // always leaf nodes.
        // TODO: Investigate why the loader produces these fake page segments.
        segment.startsWith(_segment.PAGE_SEGMENT_KEY) || // This is inserted by the loader. We should consider encoding these
