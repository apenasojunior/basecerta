...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, debugPrerender = false, noMangling = false, appDirOnly = false, bundler = Bundler.Turbopack, experimentalBuildMode, traceUploadUrl, debugBuildAppPaths, debugBuildPagePaths) {
    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (middlewareFilePath) {
                if (proxyFilePath) {
                    ...
                    throw Object.defineProperty(new Error(`Both ${MIDDLEWARE_FILENAME} file "./${path.relative(cwd, absoluteMiddlewarePath)}" and ${PROXY_FILENAME} file "./${path.relative(cwd, absoluteProxyPath)}" are detected. Please use "./${path.relative(cwd, absoluteProxyPath)}" only.`), "__NEXT_ERROR_CODE", {
                        value: "E884",
                        enumerable: false,
                        configurable: true
                    });
       ...
       */ const sourcePages = new Map();
            ...
            await recordFrameworkVersion("16.0.0-canary.16");
