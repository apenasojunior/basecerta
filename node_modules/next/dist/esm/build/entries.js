...
import { PAGES_DIR_ALIAS, ROOT_DIR_ALIAS, APP_DIR_ALIAS, WEBPACK_LAYERS, INSTRUMENTATION_HOOK_FILENAME, PROXY_FILENAME, MIDDLEWARE_FILENAME } from '../lib/constants';
            ...
            runDependingOnPageType({
                ...
                onServer: ()=>{
                    if (pagesType === 'app' && appDir) {
                        ...
                        server[serverBundlePath// proxy.js still uses middleware.js for bundle path for now.
                        // TODO: Revisit when we remove middleware.js.
                        .replace(PROXY_FILENAME, MIDDLEWARE_FILENAME).replace('src/', '')] = getEdgeServerEntry({
                            ...params,
                            rootDir,
                ...
                onEdgeServer: ()=>{
                    ...
                    if (isInstrumentation) {
                        ...
                        const edgeServerBundlePath = isMiddlewareFile(page) ? serverBundlePath.replace(PROXY_FILENAME, MIDDLEWARE_FILENAME).replace('src/', '') : serverBundlePath;
