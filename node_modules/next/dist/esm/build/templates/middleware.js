...
if (typeof handler !== 'function') {
    throw Object.defineProperty(new Error(`The ${isProxy ? 'Proxy' : 'Middleware'} file "${relativeFilePath.startsWith('.') ? relativeFilePath : `./${relativeFilePath}`}" must export a function named \`${isProxy ? 'proxy' : 'middleware'}\` or a default function.`), "__NEXT_ERROR_CODE", {
        value: "E883",
        enumerable: false,
        configurable: true
    });
