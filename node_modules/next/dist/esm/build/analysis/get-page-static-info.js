...
function validateMiddlewareProxyExports({ ast, page, pageFilePath }) {
    ...
    if (!hasValidExport) {
        throw Object.defineProperty(new Error(`The ${fileName === 'proxy' ? 'Proxy' : 'Middleware'} file "./${basename(pageFilePath)}" must export a function named \`${fileName}\` or a default function.`), "__NEXT_ERROR_CODE", {
            value: "E882",
            enumerable: false,
            configurable: true
        });
