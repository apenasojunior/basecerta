    ...
    try {
        ...
        await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            for (const rootPath of rootPaths){
                ...
                const isAtConventionLevel = fileDir === '/' || fileDir === '/src' || // rootPaths are currently relative paths from the root directory.
                // Add safety check here for unexpected future changes.
                fileDir === dir || fileDir === _path.default.join(dir, 'src');
            ...
            if (middlewareFilePath) {
                if (proxyFilePath) {
                    ...
                    throw Object.defineProperty(new Error(`Both ${_constants.MIDDLEWARE_FILENAME} file "./${_path.default.relative(cwd, absoluteMiddlewarePath)}" and ${_constants.PROXY_FILENAME} file "./${_path.default.relative(cwd, absoluteProxyPath)}" are detected. Please use "./${_path.default.relative(cwd, absoluteProxyPath)}" only.`), "__NEXT_ERROR_CODE", {
                        value: "E884",
                        enumerable: false,
                        configurable: true
                    });
       ...
       */ const sourcePages = new Map();
            ...
            await (0, _builddiagnostics.recordFrameworkVersion)("16.0.0-canary.16");
